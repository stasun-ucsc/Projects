...
void set(List L, char *x); // Overwrites the cursor element’s data with x.
...
void prepend(List L, char *x); // Insert new element into L. If L is non-empty,
    // insertion takes place before front element.

void append(List L, char *x); // Insert new element into L. If L is non-empty,
    // insertion takes place after back element.

void insertBefore(List L, char *x); // Insert new element before cursor.
    // Pre: length()>0, index()>=0

void insertAfter(List L, char *x); // Insert new element after cursor.
    // Pre: length()>0, index()>=0
